...
from ads.models import Anuncio  # Importando do app ads, não do mod
...
class ModerationDetailView(ModeratorRequiredMixin, DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return redirect('mod:detail', pk=anuncio.pk) 