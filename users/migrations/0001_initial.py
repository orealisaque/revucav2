    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('onlyfans', models.CharField(blank=True, max_length=100)),
        ...
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['cidade'], name='users_custo_cidade_429a7c_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['estado'], name='users_custo_estado_4c0426_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['usuario'], name='users_acomp_usuario_b4473f_idx'),
        ),
    ]
